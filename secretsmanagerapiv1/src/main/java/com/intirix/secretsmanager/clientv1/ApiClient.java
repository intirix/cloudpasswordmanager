...
import com.intirix.secretsmanager.clientv1.auth.HttpBasicAuth;
import com.intirix.secretsmanager.clientv1.auth.ApiKeyAuth;
import com.intirix.secretsmanager.clientv1.auth.OAuth;
import com.intirix.secretsmanager.clientv1.auth.OAuth.AccessTokenListener;
import com.intirix.secretsmanager.clientv1.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://secretsmanager.example.com/v1";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
